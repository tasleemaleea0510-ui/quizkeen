    ...
    <div className="min-h-screen bg-slate-950 px-4 py-10">
      ...
      <div className="mx-auto max-w-6xl">
        <div className="ice-glow rounded-3xl border border-sky-500/40 bg-sky-500/5 p-6">
          ...
          <p className="mt-1 text-sm text-slate-400">Övervaka, varna och kyla ner bråkmakare (5 min / 1 tim). Allt loggas. 👁️</p>
        </div>
                ...
                <div key={u.id} className="rounded-xl border border-slate-800 bg-slate-950/60 p-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <p className="font-bold text-white">
                      {u.username} <span className="ml-1 text-xs text-slate-500">{u.role} · Lv {u.level} · ⚠️ {u.warnings}/3</span>
