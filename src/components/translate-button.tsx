...
// ═══════════════════════════════════════════════════════════════
//  QUIZKEEN MEGA TRANSLATOR — EXACT WORDS (whole-text matches)
// ═══════════════════════════════════════════════════════════════
const EXACT: Record<string, string> = {
  ...
  "Dags att byta namn!": "Time to change your name!", "Välj ett nytt namn": "Pick a new name",
  "Spara nytt namn": "Save new name", "Nej": "No", "Dela": "Share",
  // ─── COMMAND UNLOCK ───
...
// ═══════════════════════════════════════════════════════════════
//  MEGA TRANSLATOR — PHRASES (partial-text matches, long = safe)
// ═══════════════════════════════════════════════════════════════
...
export default function TranslateButton() {
  ...
  useEffect(() => {
    ...
    // smart matcher: exact → emoji-stripped core → long phrases
