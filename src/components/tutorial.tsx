    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-3xl border border-indigo-500/40 bg-slate-900 p-8 shadow-2xl shadow-indigo-500/20">
            <button
              onClick={close}
